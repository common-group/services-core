...
adminApp.models = {}, adminApp.submodule = function(module, args) {
    ...
    view: function(ctrl) {
        return [ m.component(adminApp.AdminContributionsFilter, {
            ...
            contributions: ctrl.contributions
        }) ]), m(".w-section.section", [ m(".w-container", [ m(".w-row", [ m(".w-col.w-col-5"), m(".w-col.w-col-2", [ m("a.btn.btn-medium.btn-terciary[href='#']", "Carregar mais") ]), m(".w-col.w-col-5") ]) ]) ]) ];
    }
