    ...
    return {
        ...
        view: function view(ctrl, args) {
            ...
            return m('nav-wrapper', [m(mainClass, {
                ...
                style: 'float: left;'
            }, ['Novidades ', m('span.badge', h.selfOrEmpty(project.posts_count, '-'))]), m('a[id="contributions-link"][class="w-hidden-small w-hidden-tiny dashboard-nav-link mf ' + (h.hashMatch('#contributions') ? 'selected' : '') + '"][href="#contributions"]', {
                style: 'float: left;'
