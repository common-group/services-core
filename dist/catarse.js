        ...
        controller: function controller() {
            var filters = m.postgrest.filtersVM,
                ...
                var route = window.location.hash.match(/\#([^\/]*)\/?(\d+)?/),
                    loadProjects = function loadProjects(pageTitle, filter, selectedCategory) {
                    title(pageTitle);
