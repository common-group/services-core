...
window.c.AdminContributionUser = (function (m) {
    return {
        view: function view(ctrl, args) {
            ...
            var additional_data = m('.fontsize-smallest.fontcolor-secondary', 'Gateway: ' + item.payer_email);
