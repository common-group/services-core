...
var surveys = {
    ...
    view: function view(ctrl) {
        ...
        return project ? m('.project-surveys', project.is_owner_or_admin ? m.component(projectDashboardMenu, {
            ...
            !canBeCreated(reward) && !cannotBeCreated(reward) ? m('a.btn.btn-inline.btn-small.btn-terciary.fa.fa-download.fa-lg.w-button[href=\'/pt/reports/contribution_reports_for_project_owners.csv?project_id=' + project.project_id + '&amp;reward_id=' + reward.id + '&amp;state=paid\'][target=\'_blank\']') : '']), availableAction(reward)]))]);
        })])])]))) : h.loader();
    }
};
...
var surveyCreate = {
    controller: function controller(args) {
        ...
        var choiceDropdown = function choiceDropdown(question) {
            ...
            }, [m('.dropdown-toggle.w-dropdown-toggle', [choice[question.type], m('span.w-icon-dropdown-toggle')]), m('.card.dropdown-list.w-dropdown-list', {
...
var surveyPreview = {
    ...
    view: function view(ctrl, args) {
        return m('.section.u-marginbottom-40', m('.w-container', m('.w-row', [m('.w-col.w-col-1'), m('.w-col.w-col-10', m('.card.card-terciary.medium.u-radius', [args.confirmAddress ? m('.u-marginbottom-30', [m('.fontcolor-secondary.fontsize-base.fontweight-semibold.u-marginbottom-20', I18n$1.t('delivery_address', I18nScope$28())), m('.fontsize-base', [m('span.fontweight-semibold', I18n$1.t('country', I18nScope$28()) + ': '), args.countryName, m('br'), m('span.fontweight-semibold', I18n$1.t('address_street', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_street, m('br'), m('span.fontweight-semibold', I18n$1.t('address_number', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_number, m('br'), m('span.fontweight-semibold', I18n$1.t('address_complement', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_complement, m('br'), m('span.fontweight-semibold', I18n$1.t('address_neighbourhood', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_neighbourhood, m('br'), m('span.fontweight-semibold', I18n$1.t('address_city', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_city, m('br'), m('span.fontweight-semibold', I18n$1.t('address_state', I18nScope$28()) + ':'), m.trust('&nbsp;'), args.stateName, m('br'), m('span.fontweight-semibold', I18n$1.t('address_zip_code', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.address_zip_code, m('br'), m('span.fontweight-semibold', I18n$1.t('phone_number', I18nScope$28()) + ':'), m.trust('&nbsp;'), ctrl.fields().addresses_attributes.phone_number])]) : '', _$1.map(ctrl.multipleChoiceQuestions, function (item) {
            return m('.u-marginbottom-30', [m('.fontcolor-secondary.fontsize-base.fontweight-semibold.u-marginbottom-20', item.question.question), _$1.find(item.question.question_choices, function (choice) {
                return item.value() == choice.id;
            }).option]);
        }), _$1.map(ctrl.openQuestions, function (item) {
            return m('.u-marginbottom-30', [m('.fontcolor-secondary.fontsize-base.fontweight-semibold.u-marginbottom-20', item.question.question), item.value()]);
        })])), m('.w-col.w-col-1')])));
    }
};
...
var addressForm = {
    controller: function controller(args) {
        var countriesLoader = postgrest$1.loader(models.country.getPageOptions()),
            ...
            disableFields = m.prop(_$1.isEmpty(fields.addressStreet()));
    ...
    view: function view(ctrl, args) {
        ...
        }) : '']), m('.w-col.w-col-6')]), m('div', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_street', I18nScope$29()) + ' *'), m("input.positive.text-field.w-input[maxlength='256'][required='required'][type='text']", {
            class: errors.addressStreet() ? 'error' : '',
        ...
        }) : '']), m('.w-row', [m('.w-sub-col.w-col.w-col-4', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_number', I18nScope$29()) + ' *'), m("input.positive.text-field.w-input[required='required'][type='text']", {
        ...
        }) : '']), m('.w-sub-col.w-col.w-col-4', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_complement', I18nScope$29()) + ' *'), m("input.positive.text-field.w-input[required='required'][type='text']", {
            disabled: ctrl.disableFields(),
            value: ctrl.fields.addressComplement(),
            onchange: m.withAttr('value', ctrl.fields.addressComplement)
        })]), m('.w-col.w-col-4', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_neighbourhood', I18nScope$29()) + ' *'), m("input.positive.text-field.w-input[required='required'][type='text']", {
        ...
        }) : ''])]), m('.w-row', [m('.w-sub-col.w-col.w-col-6', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_city', I18nScope$29()) + ' *'), m("input.positive.text-field.w-input[required='required'][type='text']", {
            class: errors.addressCity() ? 'error' : '',
            disabled: ctrl.disableFields(),
            value: ctrl.fields.addressCity(),
            onchange: m.withAttr('value', ctrl.fields.addressCity)
        ...
        }) : '']), m('.w-col.w-col-6', [m('.field-label.fontweight-semibold', {
            class: ctrl.disableFields() ? 'fontcolor-terciary' : ''
        }, I18n$1.t('address_state', I18nScope$29()) + ' *'), m('select.positive.text-field.w-select', {
...
var surveysShow = {
    ...
    view: function view(ctrl) {
        ...
        return m('.survey', ctrl.displayModal() ? m.component(modalBox, {
            ...
            openQuestions: openQuestions,
            multipleChoiceQuestions: multipleChoiceQuestions
        }), m('div', m('.w-container', m('.w-row', [m('.w-col.w-col-2'), m('.w-col.w-col-8', m('.w-row', [m('.w-col-small-6.w-col.w-col-6.w-col-small-6.w-col-tiny-6', m('a.btn.btn-large.btn-terciary', {
...
var userPrivateContributed = {
    ...
    view: function view(ctrl, args) {
        ...
        }), m('.divider.u-marginbottom-40.u-margintop-40'), m.component(userContributedList, {
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
