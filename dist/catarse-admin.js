...
var adminApp = window.adminApp = {
    ...
    adminApp.timezone || "America/Sao_Paulo";
...
adminApp.PaymentBadge = {
    ...
    controller: function(args) {
        ...
        this.CSSsuccess = ".text-success", this.CSSwaiting = ".text-waiting", this.CSSrefunded = ".text-refunded",
        this.CSSerror = ".text-error", this.paymentDetails = function() {
