    ...
    return {
        controller: (args) => {
            let filtersVM = m.postgrest.filtersVM({
                ...
                flexAcceptTerm = m.prop([true,true,true,true,true,true,true,true]),
        ...
        view: function(ctrl, args) {
            const project = _.first(ctrl.projectDetails()),
              flexTerms = [
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "1/8"),
                          " ",
                    ...
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "2/8"),
                          " ",
                    ...
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "3/8"),
                          " ",
                    ...
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "4/8"),
                          " ",
                    ...
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "5/8"),
                          " ",
                    ...
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "6/8"),
                          " ",
                        m("span.fontweight-semibold", "O que pode e não pode alterar na página do projeto a partir da publicação?")
                      ]),
                      m("div", [
                        m("span.fontweight-semibold", "Você não poderá:"),
                        m("br"),
                        m("br"),
                        m("span.fontweight-semibold", "Você poderá: "),
                        "definir o prazo de encerramento da arrecadação, editar  o conteúdo da descrição do projeto, alterar o vídeo principal da campanha, a imagem do projeto, a frase de efeito as recompensas onde não existirem apoios efetuados, além de adicionar novas recompensas durante a arrecadação."
                      ])
                    ]),
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "7/8"),
                          " ",
                        m("span.fontweight-semibold", "Responsabilidade do Catarse")
                      ]),
                      m("div", [
                        m("span.fontweight-semibold"),
                        m("span.fontweight-semibold", "O Catarse é responsável:"),
                        m("br"),
                        m("br"),
                        m("span.fontweight-semibold", "O Catarse não é responsável:"),
                        " pelo financiamento, divulgação e execução, nem pela entrega de recompensas dos projetos inscritos."
                      ])
                    ]),
                    m(".w-col.w-col-11", [
                      m("div", [
                          m("span.fontsize-smallest.fontcolor-secondary", "8/8"),
                          " ",
              ...
              terms = [ m(".w-col.w-col-11", [
                      ...
                      m(".w-col.w-col-11", [
                        ...
                        m("div", "Seu projeto estará em arrecadação no Catarse até o dia XX/XX/XX às 23h59min59s. Este prazo não poderá ser alterado após a publicação do projeto.")
                      ]),
                      ...
                      m(".w-col.w-col-11", [
                        ...
                        m("div", [
                          ...
                          m("br"),
                          m("span.fontweight-semibold", "Você poderá: "),
                          "editar o conteúdo da descrição do projeto, alterar o vídeo principal da campanha, a imagem do projeto, a frase de efeito as recompensas onde não existirem apoios efetuados, além de adicionar novas recompensas durante a arrecadação."
                        ])
                      ]),
            ...
            m(".w-section.section-one-column.bg-gray.section.before-footer", [
              m(".w-container", [
                ...
                m(".card.medium.u-radius.u-marginbottom-60", [
                  ...
                  _.map(project.mode == 'flex' ? flexTerms : terms, (term, index) => {
