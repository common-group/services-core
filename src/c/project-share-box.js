...
const projectShareBox = {
    ...
    view(ctrl, args) {
        return m('.pop-share.fontcolor-primary', {
            ...
            projectVM.isSubscription(args.project) ? null : m('a.w-hidden-small.widget-embed.w-hidden-tiny.fontsize-small.link-hidden.fontcolor-secondary[href="javascript:void(0);"]', {
