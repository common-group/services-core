                            ...
                            [
                                ...
                                m(".fontsize-smaller.fontweight-semibold",
                                    [
                                        ...
                                        `Confirmado em ${h.momentify(contribution.paid_at)}`
                                    ]
                                ),
                                m(".fontsize-smallest", 
                                ...
                                m(".w-checkbox.fontsize-smallest.fontcolor-secondary.u-margintop-10",
                                    [
                                        m(`input.w-checkbox-input[data-remote='true'][data-url='https://www.catarse.me/pt/projects/${contribution.project_id}/contributions/${contribution.contribution_id}/toggle_anonymous'][id='anonymous'][name='anonymous'][type='checkbox']${contribution.anonymous ? '[checked=\'checked\']' : ''}[value='1']`),
