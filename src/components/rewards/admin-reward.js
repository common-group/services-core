adminApp.AdminReward = {
  view: function(ctrl, args) {
    ...
    return m('.w-col.w-col-4',[
      m('.fontweight-semibold.fontsize-smaller.lineheight-tighter.u-marginbottom-20', 'Recompensa' + (reward.maximum_contributions ? ' (limitada)' : '')),
      m('.fontsize-smallest.lineheight-looser', (_.isEmpty(reward)) ? 'Apoio sem recompensa.' : [
          ...
          m('br'),
          m.trust('Disponíveis: ' + (available) + ' / ' + ((reward.maximum_contributions) ? reward.maximum_contributions : '&infin;')),
          m('br'),
