# Automatic recharge or inactive card subscriptions

Try charge a card subscription that is active or started with the last payment refused a least 3 times in a interval of 4 days before subscription goes to inactive

### example result
```json
{
    "total_subscriptions_affected": 1,
    "affected_subscriptions_ids": ["c34198c5-f17a-4b0f-a6dd-1eae2a58fdcc"],
    "recharged_payment_ids": ["9846fe57-604e-4a04-93b8-8c224f05cb33"]
}
```
