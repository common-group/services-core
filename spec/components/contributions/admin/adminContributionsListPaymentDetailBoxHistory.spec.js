describe('AdminContributionsListPaymentDetailBoxHistory component', function() {
  beforeAll(function(){
    contribution = m.prop(ContributionDetailMockery(1));
    historyBox = m.component(adminApp.AdminContributionsListPaymentDetailBoxHistory,  {contribution: contribution()[0]})
