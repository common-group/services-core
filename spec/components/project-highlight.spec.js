describe('ProjectHighlight', () => {
  ...
  it('when project video is not filled should render image', () => {
    projectDetail = _.extend({}, ProjectDetailsMockery()[0], {original_image: 'original_image', video_embed_url: null});
    ...
    expect($output.find('img.w-embed.w-video.project-video.mf').length).toEqual(1);
