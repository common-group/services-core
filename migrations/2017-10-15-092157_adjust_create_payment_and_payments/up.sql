...
grant select, insert on payment_service.catalog_payment_versions to platform_user, scoped_user;
grant usage on sequence payment_service.catalog_payment_versions_id_seq to platform_user, scoped_user;
