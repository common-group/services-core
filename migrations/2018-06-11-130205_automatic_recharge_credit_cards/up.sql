...
$$;
comment on function payment_service.automatic_recharge_or_inactive_card_subscriptions() is 'Automatic recharge and inactice credit card subscriptions that is active or started with refused payments';