...
alter table payment_service.catalog_payments
    add column reward_id bigint references project_service.rewards(id);
...
create or replace function payment_service_api.pay(data json)
 ...
 -- if payment_method is credit_card should check for card_hash or card_id
            ...
            insert into payment_service.catalog_payments (
                platform_id, project_id, user_id, reward_id, data, gateway
            ) values (
    ...
    $$;
grant execute on function payment_service_api.pay(json) to platform_user, scoped_user;
