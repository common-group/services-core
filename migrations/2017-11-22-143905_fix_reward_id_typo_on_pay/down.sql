...
AS $function$
 ...
 -- if payment_method is credit_card should check for card_hash or card_id
            ...
            if ($1->>'subscription') is not null and ($1->>'subscription')::boolean  then
                ...
                ) values (_payment.platform_id, _payment.project_id, _payment.user_id, reward.id, payment_service._serialize_subscription_basic_data(_payment.data::json)::jsonb)
