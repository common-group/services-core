...
GRANT SELECT ON TABLE payment_service_api.subscriptions_per_month TO platform_user;
GRANT SELECT ON TABLE payment_service_api.subscriptions_per_month TO scoped_user;
