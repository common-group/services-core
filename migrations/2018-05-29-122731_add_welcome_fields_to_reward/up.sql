...
AS $function$
        ...
        begin
            select json_build_object(
                ...
                'title', ($1->>'title')::text,
                'welcome_message_subject', ($1->>'welcome_message_subject')::text,
                'welcome_message_body', ($1->>'welcome_message_body')::text,
...
AS $function$
        ...
        begin
            select json_build_object(
                ...
                'welcome_message_subject',  coalesce(($1->>'welcome_message_subject')::text, ($2->>'welcome_message_subject')::text),
                'welcome_message_body',  coalesce(($1->>'welcome_message_body')::text, ($2->>'welcome_message_body')::text),
