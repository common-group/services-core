-- Your SQL goes here
grant insert, select on payment_service.subscription_versions to scoped_user, platform_user;
grant insert, select on payment_service.credit_cards to scoped_user, platform_user;
grant usage on schema payment_service_api to anonymous;
...
AS $$
    ...
    begin
        ...
        if _subscription.status = 'inactive' then
