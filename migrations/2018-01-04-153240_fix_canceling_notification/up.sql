...
UPDATE notification_service.notification_global_templates set label = 'canceling_subscription' where label = 'canceling_subscription_payment';
...
AS $function$
        ...
        begin
            ...
            when 'canceling' then
            -- deliver notifications after status changes to inactive
            perform notification_service.notify('canceling_subscription_payment', _relations_json);
            when 'canceled' then
