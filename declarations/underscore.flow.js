...
declare module "underscore" {
  ...
  declare function compose(a: Function, ...z: Function): Function;
  ...
  declare function first<T>(a: Array<T> | NodeList<T> | HTMLCollection<T>): T;
  ...
  declare function isNumber(a: any, n?: number): boolean;
