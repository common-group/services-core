...
/*
 * notificationServiceNotify(client, label, body_with_relations)
 * Use notification_service.notify to deliver a notification to user
 * @param { Object } client - pool connection client
 ...
 */
const notificationServiceNotify = async (client, label, body_with_relations) =>  {
