module CommonModels
  class Project < ActiveRecord::Base
    FIELDS = [:category_id, :goal, :headline, :video_url, :created_at, :updated_at, :about_html, :recommended, :video_thumbnail, :state, :online_days, :more_links, :uploaded_image, :video_embed_url, :audited_user_name, :audited_user_cpf, :audited_user_moip_login, :audited_user_phone_number, :traffic_sources, :budget, :full_text_index, :budget_html, :expires_at, :city_id, :origin_id, :service_fee, :total_installments, :tracker_snippet_html, :ip_address, :published_ip, :skip_finish, :admin_notes, :cover_image, :common_id]
