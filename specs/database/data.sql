...
insert into public.platforms(id, name, token)
    values (9999, 'test_platform_01', 'a28be766-bb36-4821-82ec-768d2634d78b');
insert into public.platform_users(platform_id, user_id) values (9999, 9999);

insert into public.platform_api_keys(id, platform_id, token)
