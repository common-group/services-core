BEGIN;
    ...
    select function_returns('community_service_api', 'user_details', ARRAY['uuid'], 'jsonb');

    prepare user_details as select * from community_service_api.user_details($1::uuid);
