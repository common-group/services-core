BEGIN;
    ...
    begin
        ...
        return next is(_result -> 'customer' -> 'address' ->> 'country_code', _default_data -> 'customer' -> 'address' ->> 'country_code');
    ...
    begin
        ...
        return next is(_result -> 'customer' -> 'address' ->> 'country_code', _expected -> 'customer' -> 'address' ->> 'country_code');
