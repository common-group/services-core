...
AS $function$
        declare
            ...
            _should_skip_notification boolean default false;
        begin
            ...
            select coalesce((reason->>'skip_notification')::boolean, false) into _should_skip_notification;
            ...
            if not _should_skip_notification then
                case $2
                when 'paid' then
