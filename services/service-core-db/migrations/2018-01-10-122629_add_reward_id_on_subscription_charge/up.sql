            ...
            loop
                ...
                if _refined is not null then
                    insert into payment_service.catalog_payments(gateway, platform_id, reward_id, project_id, user_id, subscription_id, data)
                        values (_last_paid_payment.gateway, _subscription.platform_id, _subscription.reward_id, _subscription.project_id, _subscription.user_id, _subscription.id, _refined)
