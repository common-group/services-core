...
RSpec.describe ProjectFiscal, type: :model do
  ...
  describe 'Validations' do
    ...
    it { is_expected.to validate_numericality_of(:total_antifraud_fee).is_greater_than_or_equal_to(1) }
    it { is_expected.to validate_numericality_of(:total_chargeback_cost).is_greater_than_or_equal_to(1) }
  end
end
