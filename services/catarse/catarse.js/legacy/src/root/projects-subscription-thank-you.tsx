                            ...
                            m('.thanks-header-title', [
                                ...
                                m('.thanks-header-instructions-wrapper',
                                    m('.thanks-header-instructions',
                                        m('.fontsize-smaller',
                                            m.trust(window.I18n.t('thank_you.subscription_edit.text_html',
                                            I18nScope({
                                                email: user.email
                                            })))
                                        )
