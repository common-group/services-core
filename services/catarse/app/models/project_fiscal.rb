...
class ProjectFiscal < ApplicationRecord
  ...
  monetize :total_antifraud_fee_cents, numericality: { greater_than_or_equal_to: 1 }
  monetize :total_chargeback_cost_cents, numericality: { greater_than_or_equal_to: 1 }
end
