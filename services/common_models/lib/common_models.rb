...
require 'common_models/models/survey'
require 'common_models/models/survey_address_answer'
require 'common_models/models/survey_multiple_choice_question'
require 'common_models/models/survey_multiple_choice_question_answer'
require 'common_models/models/survey_open_question'
require 'common_models/models/survey_open_question_answer'
require 'common_models/models/survey_question_choice'
